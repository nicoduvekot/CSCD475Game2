...
public class TutorialUI : MonoBehaviour
{
    ...
    private string[] book = new string[]
    {
        ...
        "My liege you should try to take a point. If you move a unit next to a building you can capture it. To capture you must have more units then the enemy to capture a point. Different points give us different rewards. Some give us more resources while we hold them while if we get another fort we can recruit units there.",
